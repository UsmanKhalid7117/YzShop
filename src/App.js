...
import { BrandPage } from './features/admin/components/Brand';
import { CatergoryPage } from './features/admin/components/Catergory';
import CategoryPageUI from './features/Category/CategoryPageUI';
import BrandUI from './features/brands/components/brandsUI';
      ...
      <>
...

        {
          loggedInUser?.isAdmin?(
            ...
            <Route path='/admin/brands' element={<Protected><BrandPage/></Protected>}/>
            <Route path='/admin/categories' element={<Protected><CatergoryPage/></Protected>}/>
